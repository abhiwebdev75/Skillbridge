...
      // Optionally handle this error with a user-facing message
    }
  };
...
      await saveUserToFirestore(userCredential.user, role, name);
      navigate('/login');
    } catch (err) {
...
        {/* Role Selection */}
        <div className="mb-6">
          <h3 className="block text-gray-700 text-sm font-semibold mb-2">Register as:</h3>
