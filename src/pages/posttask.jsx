...
const PostTask = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:3001/api/post-task", {
        method: "POST",
        headers: {
  ...
  // Form UI
  const FormView = (
    <div className="bg-white my-15 p-8 rounded-2xl shadow-xl max-w-2xl w-full">
      <h2 className="text-4xl font-extrabold mb-6 text-center text-gray-800">Post a New Task</h2>
      {message && (
        <div
          className={`p-4 rounded-xl mb-4 text-center text-sm font-medium ${
      ...
      <form className="space-y-6" onSubmit={handleSubmit}>
        ...
        <textarea 
          ...
          required 
          className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors h-32"
        />
        <div>
        ...
        <div className="flex gap-4">
          <button 
            ...
            className="w-full py-3 px-6 rounded-lg text-lg font-semibold text-white bg-blue-500 hover:bg-blue-600 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
          >
            Preview
          </button>
          <button 
  ...
  const PreviewView = (
    <div className="bg-white p-8 rounded-2xl shadow-xl max-w-2xl w-full">
      <h2 className="text-3xl font-bold mb-4">Task Preview</h2>
      <div className="space-y-4 text-gray-800">
        <p><strong>Title:</strong> {formData.taskTitle}</p>
